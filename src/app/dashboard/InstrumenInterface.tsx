...
export default function InstrumenInterface({ projectId, isActive, limits, role, isPaidApi }: InstrumenInterfaceProps) {
  ...
  const [isEditingConceptualSkalaV2, setIsEditingConceptualSkalaV2] = useState(false);
  const [isEditingOperationalSkalaV2, setIsEditingOperationalSkalaV2] = useState(false);
                  ...
                  <>
                    ...
                    {skalaV2Step >= 2 && (
                      <div style={{ paddingBottom: skalaV2Step > 2 ? '24px' : '0', borderBottom: skalaV2Step > 2 ? '1px solid var(--border)' : 'none', marginBottom: skalaV2Step > 2 ? '24px' : '0' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                          <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>AI telah menyintesis definisi konseptual (abstrak) dari teori kajian pustaka Anda. Anda dapat mengeditnya sebelum lanjut.</p>
                          <button onClick={() => setIsEditingConceptualSkalaV2(!isEditingConceptualSkalaV2)} className={styles.btnSecondary} style={{ padding: '4px 12px', fontSize: '12px' }}>
                            {isEditingConceptualSkalaV2 ? 'Selesai Edit' : 'Edit Manual'}
                          </button>
                        </div>
                        {isEditingConceptualSkalaV2 ? (
                          <textarea 
                    ...
                    {skalaV2Step >= 3 && (
                      <div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                          ...
                          <button onClick={() => setIsEditingOperationalSkalaV2(!isEditingOperationalSkalaV2)} className={styles.btnSecondary} style={{ padding: '4px 12px', fontSize: '12px' }}>
                            {isEditingOperationalSkalaV2 ? 'Selesai Edit' : 'Edit Manual'}
                          </button>
                        </div>
                        {isEditingOperationalSkalaV2 ? (
                          <textarea 
