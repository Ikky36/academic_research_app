...
export default function MethodologyRecommendationInterface({ projectId, isActive, isPaidApi }: MethodologyRecommendationInterfaceProps) {
  ...
  return (
    <div className={styles.container}>
      ...
      {!isReady ? (
        <div className={styles.sotaResult} style={{ marginTop: '24px', padding: '24px', backgroundColor: 'var(--surface-container-high)', border: '1px solid var(--border)', borderRadius: '8px' }}>
        ...
        <>
          <div className={styles.sotaResult} style={{ marginTop: '24px', borderTop: '2px dashed var(--border)', paddingTop: '24px' }}>
            <div style={{ marginBottom: '20px', padding: '16px', backgroundColor: 'var(--surface-container-low)', borderRadius: '8px' }}>
              ...
              <div style={{ fontSize: '14px', lineHeight: '1.6', maxHeight: '150px', overflowY: 'auto' }}>
            ...
            >
              {isGenerating ? 'Menganalisis Pendekatan dengan AI...' : '💡 Konsultasikan Pendekatan Penelitian'}
            </button>
