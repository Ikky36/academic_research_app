...
export async function POST(req: NextRequest) {
  try {
    ...
    const { sotaMarkdown, researchTopic, projectId, gapType } = await req.json();
    ...
    const gapMarkdown = await generateGapAndNovelty(sotaMarkdown, researchTopic, undefined, gapType);
